...
<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <nav class="mt-10" x-data="{
      ...
      isRecapNonStudentMenuOpen: {{ request()->is('recaps/non-students/*') ? 'true' : 'false' }},
        ...
        <x-nav-link href="{{ route('classrooms.index') }}"
                    :active="request()->routeIs('classrooms.index')">
            <x-slot name="icon">
        ...
        <x-nav-link href="{{ route('classrooms.subjects.index') }}"
                    :active="request()->routeIs('classrooms.subjects.index')">
            <x-slot name="icon">
                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <x-nav-link href="{{ route('attendances.timetables.index') }}"
                    :active="request()->routeIs('attendances.timetables.index')">
            <x-slot name="icon">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <x-nav-link href="{{ route('classrooms.timetables.index') }}"
                    :active="request()->routeIs('classrooms.timetables.index')">
            <x-slot name="icon">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
