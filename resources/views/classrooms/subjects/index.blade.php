        ...
        @foreach ($subjects as $subject)
          <tr>
            <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
              <p class="text-gray-900 whitespace-no-wrap">{{ $subject->name }}
              </p>
            </td>
            <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
            ...
            <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
              <div class="flex flex-wrap">
                <a href="{{ route('classrooms.subjects.edit', ['subject' => $subject->id]) }}"
                ...
                <form onsubmit="return window.confirm('Apakah anda yakin?')"
                  action="{{ route('classrooms.subjects.destroy', ['subject' => $subject->id]) }}" method="POST">
                  @csrf
                  @method('DELETE')
